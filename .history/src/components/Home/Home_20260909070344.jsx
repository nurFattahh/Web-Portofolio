    ...
    <div className="row align-items-center">
      ...
      <div className="col-md-6">
        <div className="home-content">
          ...
          <p>
            I am Muhammad Nur Fattah, a Computer Engineering graduate at
            Brawijaya University. Welcome to my portfolio where I showcase my
            work, experience, and achievements. Feel free to explore and learn
          ...
          <div className="social-media mt-4">
            <div className="row">
              ...
              <div className="col-3 text-center">
                <a
                  href="https://instagram.com/mnurfatth"
                  target="_blank"
                  rel="noreferrer"
                  title="Instagram"
                >
              ...
              <div className="col-3 text-center">
                <a
                  href="https://github.com/NurFattahh"
                  target="_blank"
                  rel="noreferrer"
                  title="GitHub"
                >
            ...
            <a
              href="/CV_Muhammad_Nur_Fattah.pdf"
              download
