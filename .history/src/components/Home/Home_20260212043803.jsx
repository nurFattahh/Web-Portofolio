      ...
      <div className="col-md-6">
        ...
        <div className="social-media mt-4">
          ...
          <div className="mt-5 text-center">
              Feel free to  <span className="connect-text"><a href="https://www.linkedin.com/in/muhammad-nur-fattah/" target="_blank" className="connect-text">connect</a></span> with me
            </div>
        </div>
      </div>
    </div>
